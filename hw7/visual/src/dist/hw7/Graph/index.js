...
var _Graph_MAX_VERTS, _Graph_vertexList, _Graph_matrix, _Graph_nVerts;
...
exports.Graph = Graph;
_Graph_MAX_VERTS = new WeakMap(), _Graph_vertexList = new WeakMap(), _Graph_matrix = new WeakMap(), _Graph_nVerts = new WeakMap();
;
